...
<body>
	...
	<%
		...
		if (ejbLogin == null || !ejbLogin.isLogged()) {
			...
			request.getSession().setAttribute("articleToBuyId", longId);
			response.sendRedirect("login.jsp");
		}else{
			Long longId = new Long(Long.valueOf(request.getParameter("id")));
			Reader reader = (Reader)ejbLogin.getUser();
			ejbArticle.buyArticle(longId, reader);
			if (session.getAttribute("articleToBuyId") != null) {
				session.removeAttribute("articleToBuyId");
			}
